...
uv.exe run cluster.py ../EFTA00382108-002.png ./train_top.txt ./train_bot.txt -q
...
cat EFTA00382108-*.txt | string trim -c "> \r" | b64-debug/target/release/b64-debug --strict > airmail.pdf
